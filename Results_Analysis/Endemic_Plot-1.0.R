...
ord2 <- ord[-c(grep("Paramo", ord),grep("Cauca", ord),grep("Magdalena", ord))]
col2 <- col[-c(grep("Paramo", names(col)),grep("Cauca", names(col)),grep("Magdalena", names(col)))]

endAVTD <- end[-c(grep("Cauca", end$Area),grep("Paramo", end$Area),grep("Magdalena", end$Area)), ]
endAVTD
